...
Last verified commit: `6378f7d` (`Block Airtable decommission on cancelled projections`), with focused decommission PostgreSQL tests and the full local gate passing before persistent state docs were updated.
