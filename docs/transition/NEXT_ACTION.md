...
Last verified commit: `3bde28a` (`Dead-letter invalid scheduled jobs immediately`), with the full local gate passing before commit and only persistent state docs changed afterward.
