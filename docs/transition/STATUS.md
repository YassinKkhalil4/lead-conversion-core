...
| MP-07 Lead intake and CRM | not_started | none | Current intake authority remains n8n/Airtable; internal PostgreSQL intake command is the next unblocked slice. |
