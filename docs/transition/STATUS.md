...
| MP-06 Versioned configuration | implementing | local PostgreSQL integration tested for initial publish foundation | Immutable published configuration versions, active pointers, validation/diff/publish service, and CLI foundation added while preserving legacy `edge_config_snapshots` compatibility. |
