...
| MP-05 WhatsApp messaging platform | implementing | local contract fixtures for Meta send classification | Provider-neutral messaging port and disabled Meta WhatsApp adapter shape added. Current direct Meta send remains in active turn service until durable outbox dispatcher and cutover gates are implemented. |
