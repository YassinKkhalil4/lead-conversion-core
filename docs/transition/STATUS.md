...
| MP-05 WhatsApp messaging platform | implementing | local contract fixtures and PostgreSQL/API integration tests | Provider-neutral messaging port, disabled Meta WhatsApp adapter, durable outbox dispatcher mapping, and internal WhatsApp message request API/service added. Current direct Meta send remains in active turn service until status ingestion, policy enforcement, and cutover gates are implemented. |
