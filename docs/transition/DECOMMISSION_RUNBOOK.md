...
N8n removal requires no edge outbox target to n8n, no n8n scheduled authority, no unresolved or dead-lettered n8n inbox callbacks, no new Typebot conversation, no active legacy conversation for 14 days, direct ingress stable for 14 days, final workflow/DB export, and explicit owner approval.
