...
Threshold arguments must be plain base-10 non-negative safe integers. Decimal, scientific-notation, hexadecimal, whitespace-padded, unsafe, negative, or empty windows, counts, or heartbeat thresholds are rejected before PostgreSQL is queried.
