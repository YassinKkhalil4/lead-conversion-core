...
- `npm run reconcile:airtable -- --record-results` records checks for rejects, mapped clients/projects/salespeople/leads/qualifications/scores/messages/followups/appointments, contact phone uniqueness, and lead-contact links.
